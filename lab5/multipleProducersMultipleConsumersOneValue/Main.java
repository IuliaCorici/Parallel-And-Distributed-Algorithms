package multipleProducersMultipleConsumersOneValue;

// FOR THE CASE WITH MULTIPLE CONSUMERS AND PRODUCERS, I CONSIDERED THE QUEUE SIZE = 1
public class Main {
	...
	public static void main(String[] args) {
		...
		multipleProducersMultipleConsumersOneValue.Buffer buffer = new Buffer(BUFFER_SIZE);
